...
public sealed class CustomerShipmentTrackingEventEntity
{
...
internal sealed class CustomerShipmentTrackingEventConfiguration : IEntityTypeConfiguration<CustomerShipmentTrackingEventEntity>
{
    public void Configure(EntityTypeBuilder<CustomerShipmentTrackingEventEntity> b)
    {
